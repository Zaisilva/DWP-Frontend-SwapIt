  ...
  <section className={styles.heroBanner}>
    <div className={styles.heroContent}>
      ...
      <div className={styles.ctaContainer}>
        <Link to="/registro" className={styles.primaryButton}>Regístrate gratis</Link>
        <Link to="/comunidad" className={styles.secondaryButton}>Explorar truques</Link>
      </div>
    </div>
  ...
  return (
    <section className={styles.newsletterSection}>
      <div className={styles.newsletterContainer}>
        <h2 className={styles.newsletterTitle}>Mantente informado</h2>
        <p className={styles.newsletterDescription}>
          Recibe notificaciones sobre nuevos artículos y oportunidades de intercambio
        </p>
